"""
Enhanced combat commands with Discord UI components
...
class ContinueAfterCombatView(discord.ui.View):
    ...
    async def continue_exploring(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        from .enhanced_player import ActivitySelectionView
...
class EnhancedCombatCog(commands.Cog):
    """Enhanced combat commands with UI components"""
...
async def setup(bot):
    """Load the enhanced combat cog"""
    await bot.add_cog(EnhancedCombatCog(bot))
